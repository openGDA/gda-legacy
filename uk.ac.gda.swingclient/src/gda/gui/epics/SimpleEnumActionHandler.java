...
/**
 * SimpleEnumActionHandler Class
 */
public class SimpleEnumActionHandler implements ActionEventRunnerObserver {
	 ...
	 * @param defCommand
	 */
	public SimpleEnumActionHandler(String deviceName, String recordName, String fieldName,
	...
	public void run(EventDispatcher dispatcher, ActionEvent e) throws DeviceException {
		if (epicsChannel == null) {
			...
			epicsChannel = experimentEpicsDevice.createEpicsChannel(ReturnType.DBR_CTRL, recordName, fieldName);
		}
		if (epicsChannel != null) {
			String s = ((EpicsCtrlEnum) epicsChannel.getValue()).getValueAsString();
