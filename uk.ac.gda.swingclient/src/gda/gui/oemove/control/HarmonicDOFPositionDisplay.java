 ...
 */
public class HarmonicDOFPositionDisplay extends JTextField implements DOFPositionDisplay {
	
	private static final Logger logger = LoggerFactory.getLogger(HarmonicDOFPositionDisplay.class);
	...
	public HarmonicDOFPositionDisplay(OE oe, String dofName) {
		this.oe = oe;
	 ...
	 */
	@SuppressWarnings("unused")
	public HarmonicDOFPositionDisplay(OE oe, String dofName, int columns, boolean border) {
		this.oe = oe;
		this.dofName = dofName;
	...
	public void update(Object iObservable, Object arg) {
		...
		// DOFs such as UndulatorHarmonicDOF which use MultipleMover to
