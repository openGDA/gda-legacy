...
/**
 * FilmStrip movemement
 */

public class FilmStripMovement extends GeometryMovement {
	 ...
	 */
	public FilmStripMovement(DataSetImages texFrame, LinkedList<Integer> stackBuffer, int[] stackPositions,
