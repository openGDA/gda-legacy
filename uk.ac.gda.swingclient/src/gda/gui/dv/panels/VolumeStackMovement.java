...
/**
 * Volume Stack Movement
 */
public class VolumeStackMovement extends GeometryMovement {
	 ...
	 */
	public VolumeStackMovement(DataSetImages texFrame, LinkedList<Integer> stackBuffer, int[] stackPositions,
	...
	protected void moveGeometryForward() {
		for (int i = 0; i < numSlides; i++) {
			...
			MatrixBuilder.euclidean().translate(0, 0, -stackPos[i] * 2 * DataSetImages.GAPINSTACK).assignTo(slides[i]);
		}
	}
