...
/**
 * Draws line numbers next to each line, in the same font as the text. Currently, this can only be used with a
 * <tt>JTextArea</tt> , since it relies on the <tt>getRows()</tt> and <tt>getLineCount()</tt> methods. A possible
 * extension, create an interface to return this rows/linecount.
 */
public class LineNumberedBorder extends AbstractBorder {
	/*
	 * public static void main(String[] args) { javax.swing.JFrame frame = new javax.swing.JFrame( "Line Numbers (as
	 * Borders)..."); frame.addWindowListener(new java.awt.event.WindowAdapter() { public void
	 * windowClosing(java.awt.event.WindowEvent ev) { System.exit(0); } }); java.awt.Container contentPane =
	 * frame.getContentPane(); contentPane.setLayout(new java.awt.GridLayout(0, 2)); int[] sides =
	 * {LineNumberedBorder.LEFT_SIDE, LineNumberedBorder.LEFT_SIDE, LineNumberedBorder.RIGHT_SIDE,
	 * LineNumberedBorder.RIGHT_SIDE}; int[] justified = {LineNumberedBorder.LEFT_JUSTIFY,
	 * LineNumberedBorder.RIGHT_JUSTIFY, LineNumberedBorder.LEFT_JUSTIFY, LineNumberedBorder.RIGHT_JUSTIFY}; String[]
	 * labels = {"Left Side/Left Justified", "Left Side/Right Justified", "Right Side/Left Justified", "Right Side/Right
	 * Justified"}; javax.swing.JPanel subpanel; JTextArea textArea; boolean useMultipleBorders = false; if (args.length >
	 * 0 && "multiple".equals(args[0])) { useMultipleBorders = true; } for (int idx = 0; idx < labels.length; idx++) {
	 * textArea = new JTextArea(10, 10); LineNumberedBorder lnb = new LineNumberedBorder(sides[idx], justified[idx]); if
	 * (useMultipleBorders) { textArea.setBorder(javax.swing.BorderFactory.createCompoundBorder(
	 * javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5), javax.swing.BorderFactory.createCompoundBorder(
	 * javax.swing.BorderFactory.createLineBorder( java.awt.Color.red, 1),
	 * javax.swing.BorderFactory.createCompoundBorder(lnb, javax.swing.BorderFactory.createLineBorder(
	 * java.awt.Color.blue, 1))))); } else { textArea.setBorder(lnb); } subpanel = new javax.swing.JPanel(new
	 * java.awt.BorderLayout()); subpanel.add(new javax.swing.JLabel(labels[idx]), java.awt.BorderLayout.NORTH);
	 * subpanel.add(new javax.swing.JScrollPane(textArea), java.awt.BorderLayout.CENTER); contentPane.add(subpanel); }
	 * frame.setSize(800, 600); frame.show(); }
	 */
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
		...
		int fontHeight = fm.getHeight(); // starting location at the
		// "top"
		// of the page...
		// y is the starting baseline for the font... // should "font leading"
		// be
		// applied?
		int ybaseline = y + fm.getAscent(); // // now determine if it is the
		// "top" of the page...or
		// somewhere else //
		...
		// see getLineCount() // // determine which the "drawing" should end...
		// //
		// add fontHeight: make sure...part of the line number is drawn // //
		// could also do this by determining what the last line // number to
		// draw.
	 ...
	 * @param addSpace Description of the Parameter @return the line number for drawing
	 */
